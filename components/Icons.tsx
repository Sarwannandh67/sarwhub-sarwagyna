...
// Add missing SarwHubLogo component
export const SarwHubLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="40" height="40" rx="10" fill="white"/>
    <path d="M16 26C16 27.5 17.5 29 20 29C22.5 29 24 27.5 24 26C24 24.5 22.5 23.5 20 22.5C17.5 21.5 16 20.5 16 19C16 17.5 17.5 16 20 16C22.5 16 24 17.5 24 19" stroke="black" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const TerminalIcon = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
);
...
export const ReceiptIcon = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 14l2 2 4-4m-7 4h.01M9 10h.01M9 6h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
);
...
export const BriefcaseIcon = () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
);
...
export const BeakerIcon = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.691.346a6 6 0 00-3.86.517l-2.387-.477a2 2 0 00-1.022.547l-1.168 1.168a2 2 0 00-.547 1.022l-.477 2.387a6 6 0 00.517 3.86l.346.691a6 6 0 01.517 3.86l-.477 2.387a2 2 0 00.547 1.022l1.168 1.168z" /></svg>
);
...
export const YouTubeIcon = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
    <path d="M2.5 7.1C2.5 7.1 2.5 5 4.6 4.6C5.8 4.3 12 4.3 12 4.3S18.2 4.3 19.4 4.6C21.5 5 21.5 7.1 21.5 7.1S21.5 9.5 21.5 12C21.5 14.5 21.5 16.9 21.5 16.9S21.5 19 19.4 19.4C18.2 19.7 12 19.7 12 19.7S5.8 19.7 4.6 19.4C2.5 19 2.5 16.9 2.5 16.9S2.5 14.5 2.5 12C2.5 9.5 2.5 7.1 2.5 7.1Z" />
