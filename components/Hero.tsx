...
import { ShieldCheckIcon, LayoutIcon, WalletIcon, QRIcon, ChartBarIcon, TicketIcon } from './Icons';
  ...
  return (
    <section id="hero" className="relative pt-40 pb-24 px-6 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left space-y-10 animate-in fade-in slide-in-from-left-4 duration-700 relative z-20">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 glass rounded-full border-white/10">
            ...
            <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-white/60">Brand-First Event Management</span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-normal leading-[1.1] tracking-tighter">
            ...
            <span className="text-white/90">Built for Your</span> <span className="metal italic">Brand</span>.
          </h1>

          <p className="text-base md:text-lg text-white/50 max-w-lg leading-relaxed font-normal">
            A modern event management platform for conferences, communities, institutions, and organizers who want full brand control, flexible pricing, and professional tooling—all in one place.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <button 
              onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })}
              className="bg-white text-black px-10 py-5 rounded-2xl text-base font-medium hover:scale-105 transition-all shadow-xl shadow-white/10"
            >
              Start Selling in Minutes
            </button>
            <button 
              onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}
              className="glass px-10 py-5 rounded-2xl text-base font-medium hover:bg-white/10 transition-all border-white/10 flex items-center gap-2 group"
            >
              View Features
          ...
          <div className="pt-8 border-t border-white/5 max-w-sm">
            <p className="text-sm text-white/40 font-normal leading-relaxed">
              Can't find a plan that fits your needs? <br />
              <button onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })} className="text-white font-medium hover:underline">Contact our team</button> to create a custom package.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
            <PillarCard 
              ...
              description="Your attendee and order data is always accessible and exportable."
            />
            <PillarCard 
              icon={<LayoutIcon />}
              title="White-Label Default"
              description="Custom domains and branded checkout that feels like your product."
            />
            <PillarCard 
              icon={<WalletIcon />}
              title="Flexible Fees"
              description="Decide whether to pass fees to buyers or absorb them into pricing."
            />
          </div>

          <div className="pt-6">
            <p className="text-[9px] font-medium uppercase tracking-[0.3em] text-white/20 mb-4">Trusted by organizers, venues, and communities</p>
            <div className="flex flex-wrap gap-8 opacity-20 grayscale items-center">
              <span className="font-medium text-lg text-white">EVENTX</span>
              <span className="font-medium text-lg text-white">CLUBHUB</span>
              <span className="font-medium text-lg text-white">VENUELY</span>
              <span className="font-medium text-lg text-white">FESTIVA</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative hidden lg:block animate-in fade-in slide-in-from-right-4 duration-1000 z-10">
          <div className="relative w-full aspect-square scale-110">
            ...
            <div className="absolute top-[5%] right-0 w-[420px] glass p-1 rounded-[32px] rotate-2 shadow-2xl border-white/20 transform hover:rotate-0 transition-all duration-700 z-20 overflow-hidden">
               <div className="bg-neutral-900 rounded-[28px] overflow-hidden">
                  <div className="px-6 py-4 border-b border-white/5 flex justify-between items-center bg-black/40">
                    <span className="text-[10px] font-medium uppercase tracking-widest text-white/40">Admin Dashboard</span>
                  ...
                  <div className="p-8 space-y-6">
                    <div className="flex justify-between items-end">
                      <div>
                        <p className="text-[9px] font-medium text-white/30 uppercase tracking-widest mb-1">TOTAL SALES</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/[0.08] transition-colors">
                        <p className="text-[8px] font-medium text-white/30 tracking-widest uppercase mb-1">ATTENDEES</p>
                        <p className="text-xl font-normal">2,492</p>
                      </div>
                      <div className="p-4 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/[0.08] transition-colors">
            ...
            <div className="absolute bottom-[5%] left-[5%] w-[340px] glass p-8 rounded-[40px] -rotate-3 shadow-2xl border-white/20 z-30 hover:rotate-0 transition-all duration-500">
              <div className="flex items-start justify-between mb-8">
                <div>
                  ...
                  <p className="text-xs text-white/40 font-normal">Global Summit 2024</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <button className="w-full py-4 bg-white text-black rounded-2xl font-medium text-sm hover:bg-white/90 transition-colors">
                  Complete Booking
                </button>
              </div>
            </div>
            ...
            {/* Analytics Mini-Card */}
            <div className="absolute bottom-[25%] right-[-40px] w-64 glass p-6 rounded-[28px] -rotate-2 border-white/10 z-10 opacity-60 hover:opacity-100 hover:rotate-0 transition-all">
               <div className="flex items-center gap-4 mb-4">
                 <div className="p-2 bg-white/10 rounded-xl">
                    <ChartBarIcon />
                 </div>
                 <span className="text-[9px] font-medium uppercase tracking-widest text-white/40">Live Traffic</span>
               </div>
               <div className="flex items-end gap-1.5 h-16">
                  {[40, 70, 50, 90, 60, 80, 45, 100, 30].map((h, i) => (
                    <div key={i} className="flex-1 bg-white/10 rounded-t-sm relative overflow-hidden group">
                      <div style={{height: `${h}%`}} className="bg-white/20 group-hover:bg-white/40 transition-all"></div>
                    </div>
                  ))}
               </div>
            </div>
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-20 hover:opacity-100 transition-opacity">
        <p className="text-[9px] font-medium uppercase tracking-[0.6em] text-white text-center whitespace-nowrap">
          The Backbone of Professional Events
        </p>
      </div>
    </section>
  );
